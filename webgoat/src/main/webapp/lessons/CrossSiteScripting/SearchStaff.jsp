<%@ page contentType="text/html; charset=ISO-8859-1" language="java" 
	import="org.owasp.webgoat.util.*, org.owasp.webgoat.session.*, org.owasp.webgoat.lessons.CrossSiteScripting.CrossSiteScripting" 
	errorPage="" %>
	<div id="lesson_search">
			...
			{
			%>
				Employee <%=HtmlEncoder.encode(searchedName)%> not found.
				Employee <%=HtmlEncoder.encodeBad(searchedName)%> not found.
